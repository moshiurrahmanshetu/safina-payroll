...
function received_products(req_id){
  if(req_id != ''){
    $.ajax({
      type: "get",
      url:"{{ route('ajax.received_products') }}",
      data:{req_id:req_id},
...
function show_supplier_names(supplier_type){
  ...
  if(supplier_type == ''){
    ...
    $.ajax({
      type: "get",
      url:"{{ route('ajax.get_supplier_lists') }}",
...
function show_supllier_info(clientId){    
  if(clientId == ''){
    ...
    $.ajax({
      type: "get",
      url:"{{ route('ajax.get_supllier_info') }}",
...
function check_availability(item_id, count, combination, user_id){
  ...
  if(item_id == ''){
    ...
    $.ajax({
      type: "get",
      url:"{{ route('ajax.check_availability') }}",
...
function show_user_item_mrs(user_id){
  ...
  if(user_id == ''){
    ...
    $.ajax({
      type: "get",
      url:"{{ route('ajax.show_user_item_mrs') }}",
...
function show_mrs_item_details(req_item_id){
  if(req_item_id == ''){
    ...
    $.ajax({
      type: "get",
      url:"{{ route('ajax.get_mrs_item_info') }}",
...
function show_type_wise_item_list(type_id, item_index){
  ...
  $.ajax({
    type: "get",
    url:"{{ route('ajax.show_type_wise_item_list') }}",
...
function show_purpose_names(type_id){
  ...
  $.ajax({
    type: "get",
    url:"{{ route('ajax.show_purpose_names') }}",
    data:{type_id:type_id},
    success: function(data){
      $.each(data, function(key, value) {
