...
@section('title', 'Shown My Profile')
@section('content')
<style>.table tr{ border-bottom:1px solid #ddd !important}</style>
<h1 class="page-header">My Profile </h1>
<div class="row margin-center">
  {{ Form::model($users, array('route' => array('update_profile'), 'enctype'=>'multipart/form-data','method' => 'PUT','class'=>'form-horizontal')) }}
  ...
  <div class="col-md-12 multi-column">
    <div class="col-md-6">
      <div class="form-group">
        <label for="status" class="control-label">Mobile #  <sup>*</sup></label>
  ...
  <div class="col-md-12 multi-column"> 
    <div class="col-md-6">
      <div class="col-md-7 form-group">
        ...
        {{ Form::hidden('old_image',$users->photo) }}
      </div>
      <div class="col-md-5 preview-div">
        {{ HTML::image('storage/app/admin/users/'.$users->photo, null, array('width'=>'70', 'class'=>'img-responsive')) }}
      </div>
    </div>
    <div class="col-md-6">
      <div class="col-md-7 form-group">
        ...
        {{ Form::hidden('old_signature',$users->signature) }} 
      </div>
      <div class="col-md-5 preview-div">
        {{ HTML::image('storage/app/admin/users/'.$users->signature, null, array('width'=>'70', 'class'=>'img-responsive')) }}
      </div>
    </div>
  </div>
