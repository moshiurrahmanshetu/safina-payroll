...
@section('title', 'Attendance Month Create')
@section('content')
<h3 class="page-header">Attendance Month Create {{link_to_route('attendances.index','Attendance List',[],array('class'=>'btn btn-success pull-right'))}}</h3>

{{ Form::open(array('route' => array('attendances.store'),'enctype'=>'multipart/form-data','class'=>'form-horizontal','id'=>'attendanceForm')) }}
<div class="row">
  <div class="col-md-12">
