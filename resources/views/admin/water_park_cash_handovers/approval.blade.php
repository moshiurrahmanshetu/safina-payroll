...
@section('title', 'Water Park Cash Handover Approval')
@section('content')
<h3 class="page-header">Water Park Cash Handover Approval</h3>

<!-- Filters -->
<div class="panel-body">
    {{ Form::open(array('route' => 'water_park_cash_handovers.approval', 'method'=>'GET')) }}
    ...
    <div class="row">
        ...
        <div class="col-md-2">
            <div class="form-group">
                ...
                <select name="water_park_counter_id" class="form-control">
                    <option value="">All Counters</option>
                    @foreach($counters as $id => $name)
                        <option value="{{ $id }}" {{ request('water_park_counter_id') == $id ? 'selected' : '' }}>
                            {{ $name }}
                        </option>
                    @endforeach
                </select>
        ...
        <div class="col-md-2">
            <div class="form-group" style="margin-top:25px;">
                ...
                <a href="{{ route('water_park_cash_handovers.approval') }}" class="btn btn-danger">Reset</a>
            </div>
        </div>
        ...
        <table class="table table-striped">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                @if($handover->status == 'pending')
                  {{ Form::open(array('route' => ['water_park_cash_handovers.approve', $handover->id], 'method'=>'POST', 'class'=>'form-inline')) }}
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          {{ Form::open(array('route' => ['water_park_cash_handovers.reject', $handover->id], 'method'=>'POST')) }}
                          <div class="form-group">
