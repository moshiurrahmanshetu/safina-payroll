...
@section('content')
<h3 class="page-header">Shift Create {{link_to_route('shifts.index','Shift List',[],array('class'=>'btn btn-success pull-right'))}}</h3>

{{ Form::open(array('route' => array('shifts.store'),'enctype'=>'multipart/form-data','class'=>'form-horizontal')) }}
<div class="row">
  <div class="col-md-12">
