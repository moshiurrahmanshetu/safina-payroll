...
@section('content')
<h3 class="page-header">Payroll Edit {{link_to_route('payrolls.index','Payroll List',[],array('class'=>'btn btn-success pull-right'))}}</h3>

{{ Form::model($payroll,array('route' => array('payrolls.update', $payroll->id),'enctype'=>'multipart/form-data','method'=>'PUT','class'=>'form-horizontal')) }}
<div class="row">
  <div class="col-md-12">
        ...
        <div class="col-md-12 multi-column">
          <div class="col-md-4">
            <div class="form-group">
              ...
              <input type="month" name="payroll_month" class="form-control" id="payroll_month" value="{{ $payroll->payroll_month }}" required onchange="calculateGeneratedSalary();">
        ...
        <div class="col-md-12 multi-column">
          <div class="col-md-4">
            <div class="form-group">
              ...
              {{Form::number('bonus',null, array('class' => 'form-control', 'step'=>'0.01', 'min'=>'0', 'id'=>'bonus', 'onchange'=>'calculateGeneratedSalary();'))}}
          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              {{Form::number('deduction',null, array('class' => 'form-control', 'step'=>'0.01', 'min'=>'0', 'id'=>'deduction', 'onchange'=>'calculateGeneratedSalary();'))}}
          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              <select name="status" class="form-control" required>
                <option value="0" {{ $payroll->status == 0 ? 'selected' : '' }}>Draft</option>
                <option value="1" {{ $payroll->status == 1 ? 'selected' : '' }}>Sent To Manager</option>
                <option value="2" {{ $payroll->status == 2 ? 'selected' : '' }}>Approved</option>
                <option value="3" {{ $payroll->status == 3 ? 'selected' : '' }}>Rejected</option>
              </select>
