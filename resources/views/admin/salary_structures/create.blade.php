...
@section('content')
<h3 class="page-header">Salary Structure Create {{link_to_route('salary_structures.index','Salary Structure List',[],array('class'=>'btn btn-success pull-right'))}}</h3>

{{ Form::model(Request::old(),array('route' => array('salary_structures.store'),'enctype'=>'multipart/form-data','class'=>'form-horizontal')) }}
<div class="row">
  <div class="col-md-12">
        ...
        <div class="form-group">
          ...
          <select name="user_id" class="form-control" required>
            ...
            @if($users->count() > 0)
              ...
              @endforeach
            @else
              <option value="" disabled>No eligible employees found (users with salary_processing=1 and without salary structure)</option>
            @endif
          </select>
        ...
        <div class="col-md-12 multi-column">
          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              {{Form::number('house_rent',0, array('class' => 'form-control', 'step'=>'0.01', 'min'=>'0'))}}
          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              {{Form::number('medical',0, array('class' => 'form-control', 'step'=>'0.01', 'min'=>'0'))}}
        ...
        <div class="col-md-12 multi-column">
          <div class="col-md-4">
            <div class="form-group">
              ...
              {{Form::number('transport',0, array('class' => 'form-control', 'step'=>'0.01', 'min'=>'0'))}}
          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              {{Form::number('food',0, array('class' => 'form-control', 'step'=>'0.01', 'min'=>'0'))}}
          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              {{Form::number('mobile',0, array('class' => 'form-control', 'step'=>'0.01', 'min'=>'0'))}}
        ...
        <div class="col-md-12 multi-column">
          <div class="col-md-4">
            <div class="form-group">
              ...
              {{Form::number('other_allowance',0, array('class' => 'form-control', 'step'=>'0.01', 'min'=>'0'))}}
          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              {{Form::number('festival_bonus',0, array('class' => 'form-control', 'step'=>'0.01', 'min'=>'0'))}}
        ...
        <div class="col-md-12 multi-column">
          <div class="col-md-4">
            <div class="form-group">
              ...
              {{Form::number('late_fine',0, array('class' => 'form-control', 'step'=>'0.01', 'min'=>'0'))}}
          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              {{Form::number('absent_deduction',0, array('class' => 'form-control', 'step'=>'0.01', 'min'=>'0'))}}
          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              {{Form::number('advance_salary',0, array('class' => 'form-control', 'step'=>'0.01', 'min'=>'0'))}}
        ...
        <div class="col-md-12 multi-column">
          <div class="col-md-4">
            <div class="form-group">
              ...
              {{Form::number('tax',0, array('class' => 'form-control', 'step'=>'0.01', 'min'=>'0'))}}
          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              {{Form::number('pf',0, array('class' => 'form-control', 'step'=>'0.01', 'min'=>'0'))}}
          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              {{Form::number('other_deduction',0, array('class' => 'form-control', 'step'=>'0.01', 'min'=>'0'))}}
