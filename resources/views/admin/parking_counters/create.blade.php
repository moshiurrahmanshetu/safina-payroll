...
@section('content')
<h3 class="page-header">Create Parking Counter {{link_to_route('parking_counters.index','Parking Counter List',[],array('class'=>'btn btn-success pull-right'))}}</h3>

{{ Form::open(['route' => 'parking_counters.store', 'class' => 'form-horizontal']) }}
@csrf
<div class="row">
  <div class="col-md-6">
