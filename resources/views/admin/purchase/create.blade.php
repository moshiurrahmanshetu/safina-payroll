  ...
  <div class="col-md-12 multi-column">
    <div class="col-md-4">
      <div class="form-group">
        ...
        {{Form::text('purchase_date',null, array('class' => 'form-control datetimepicker1', 'required'=>'required'))}}
      ...
      <table class="table table-bordered table-hover" id="salescount">
        ...
        <tbody>
          <tr class="calculate-row" id="0_info" row-id='0'>
            ...
            <td>
              {{Form::select('activity[0][item_name]',array(''=>'Select Item Name')+$item_names, null, array('class' => 'form-control', 'required','onChange'=>'show_item_details(this.value, 0)'))}} 
              <span id="attri_0"></span>
              {{Form::hidden('activity[0][name]',null)}}
            </td>
            <td>
              {{Form::textarea('activity[0][description]',null,array('class' => 'form-control Item_value_0', 'placeholder'=>'Description', 'rows'=>3))}}
            </td>
            <td>
              {{Form::number('activity[0][unit_price]',null,array('class' => 'form-control calculate_unit_price1 Item_value_0','placeholder'=>'Unit Price','step'=>'any'))}}
            </td>
            <td>
              {{Form::number('activity[0][no_of_unit]',1,array('class' => 'form-control calculate_no_of_unit1 Item_value_0','placeholder'=>'No of unit','step'=>'any'))}}<br>
              {{Form::text('activity[0][measuring_unit]',null, array('class' => 'form-control Item_value_0', 'readonly'=>'readonly'))}}
            </td>
            <td>
              {{Form::number('activity[0][per_total]',null,array('class' => 'form-control','readonly','placeholder'=>'0','step'=>'any'))}}
            </td>
            <td>
