...
@section('title', 'Package Cash Handover')
@section('content')
<h3 class="page-header">Package Cash Handover</h3>

<!-- Business Date Filter -->
<div class="row">
  <div class="col-md-12">
    {{ Form::open(array('route' => 'package_cash_handovers.index', 'method'=>'GET', 'class'=>'form-inline')) }}
      ...
      <div class="card-body">
        <table class="table table-striped">
          ...
          <tbody>
            ...
            <tr>
              <td>{{ $pendingHandover->counter->name ?? 'Unknown Counter' }}</td>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        {{ Form::open(array('route' => 'package_cash_handovers.store', 'method'=>'POST')) }}
        <input type="hidden" name="business_date" value="{{ $businessDate }}">
        <input type="hidden" name="package_counter_id" value="{{ $counterBalance['counter_id'] }}">
        ...
        <div class="form-group">
          <label>Business Date:</label>
          <p class="form-control-static">{{ \Carbon\Carbon::parse($counterBalance['business_date'])->format('d-m-Y') }}</p>
        </div>
