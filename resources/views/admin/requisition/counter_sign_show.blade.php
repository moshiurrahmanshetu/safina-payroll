...
@section('title', 'Counter Sign Show')
@section('css')
<style type="text/css">
...
{{ Form::model($requisitions,array('route' => array('counter_sign_update', $requisitions->id), 'class'=>'form-horizontal', 'method' => 'PUT')) }} 
  <div class="row no-print">
    <div class="col-md-12 multi-column">
      <div class="col-md-4">
        <div class="form-group">
          <label class="control-label">Counter Sign Status <sup>*</sup></label>
          {{Form::select('counter_sign_status',config('myhelpers.counter_sign_status'),null,array('class' => 'form-control'))}}
          {!!$errors->first('counter_sign_status', '<p class="text-danger">:message</p>')!!}
        </div>
      </div>
      <div class="col-md-8">
        <div class="form-group">
          <label class="control-label">Supervisor Comments/Instructions</label>
          {{Form::textarea('supervisor_comments',null,array('class' => 'form-control', 'rows'=>'4'))}}
        </div>
      </div>
    </div>
    <div class="col-md-12 multi-column">
