...
@section('title', 'Admin Requisition List')
@section('css')
<link href="{{asset('public/css/select2.min.css')}}" rel="stylesheet" />
@endsection
@section('content')
<div class="row page-header">
  <div class="col-sm-12 col-md-3"><h3>Admin Requisition List </h3></div>
      ...
      <table class="table table-striped">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              {!!HTML::decode(link_to_route('admin_requisition_show', '<i class="nav-icon icon-eye"></i>', array($data->id)))!!}
            </td>
          </tr>
          @php $i=$i+1; @endphp
          @endforeach
