...
@section('title', 'Daily Worker Create')
@section('content')
<h3 class="page-header">Daily Worker Create {{link_to_route('daily_workers.index','Daily Worker List',[],array('class'=>'btn btn-success pull-right'))}}</h3>

{{ Form::model(Request::old(),array('route' => array('daily_workers.store'),'enctype'=>'multipart/form-data','class'=>'form-horizontal')) }}
<div class="row">
  <div class="col-md-12">
      ...
      <div class="panel-body">
        <div class="form-group">
          ...
          <div>
            ...
            <label class="radio-inline">
              <input type="radio" name="worker_type" value="new" onchange="toggleWorkerType()"> New Worker
            </label>
          </div>
        </div>
...
function loadUserDetails() {
  ...
  var url = '{{ route("daily_workers.get_user_details", ":id") }}'.replace(':id', userId);
