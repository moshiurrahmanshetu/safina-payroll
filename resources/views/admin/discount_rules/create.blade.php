...
@section('title', 'Promo Discount Create')
@section('content')
<h3 class="page-header">Promo Discount Create {{link_to_route('discount_rules.index','Promo Discount List',[],array('class'=>'btn btn-success pull-right'))}}</h3>
{{ Form::model(Request::old(),array('route' => array('discount_rules.store'),'enctype'=>'multipart/form-data','class'=>'form-horizontal')) }}
<div class="row">
