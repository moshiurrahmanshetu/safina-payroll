...
@section('title', 'Parking Cash Handover')
@section('content')
<h3 class="page-header">Parking Cash Handover</h3>

<!-- Business Date Filter -->
<div class="row">
  <div class="col-md-12">
    {{ Form::open(array('route' => 'parking_cash_handovers.index', 'method'=>'GET', 'class'=>'form-inline')) }}
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        {{ Form::open(array('route' => 'parking_cash_handovers.store', 'method'=>'POST')) }}
        <input type="hidden" name="business_date" value="{{ $businessDate }}">
        <input type="hidden" name="parking_counter_id" value="{{ $counterBalance['counter_id'] }}">
