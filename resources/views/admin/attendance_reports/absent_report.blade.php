...
@section('title', 'Absent Attendance Report')
@section('content')
<h3 class="page-header">Absent Attendance Report {{link_to_route('attendance_reports.index','Attendance Reports',[],array('class'=>'btn btn-success pull-right'))}}</h3>
  ...
  <div class="col-md-12">
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form method="GET" action="{{ route('attendance_reports.absent_report') }}">
          <div class="row">
            <div class="col-md-3">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                ...
                @if(isset($fromDate))
                <a href="{{ route('attendance_reports.absent_report_print', ['from_date' => $fromDate, 'to_date' => $toDate, 'department_id' => request('department_id'), 'employee_id' => request('employee_id')]) }}" target="_blank" class="btn btn-default">
          ...
          <div class="col-md-12">
            <div class="row">
              <div class="col-md-3">
                <div class="panel panel-default">
                  <div class="panel-body text-center">
                    <h4>{{ $summary['totalAbsentRecords'] }}</h4>
                    <small>Total Absent Records</small>
                  </div>
                </div>
              </div>
              <div class="col-md-3">
              ...
              <div class="col-md-3">
                <div class="panel panel-default">
                  <div class="panel-body text-center">
                    <h4 style="color: red;">{{ $summary['totalAbsentDays'] }}</h4>
              ...
              <div class="col-md-3">
                <div class="panel panel-default">
                  <div class="panel-body text-center">
                    <h4 style="color: #007bff;">{{ $summary['averageAbsentDays'] }}</h4>
