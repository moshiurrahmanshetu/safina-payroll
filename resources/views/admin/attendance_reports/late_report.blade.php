  ...
  <div class="col-md-12">
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form method="GET" action="{{ route('attendance_reports.late_report') }}">
          <div class="row">
            <div class="col-md-3">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                ...
                @if(isset($fromDate))
                <a href="{{ route('attendance_reports.late_report_print', ['from_date' => $fromDate, 'to_date' => $toDate, 'department_id' => request('department_id'), 'employee_id' => request('employee_id')]) }}" target="_blank" class="btn btn-default">
          ...
          <div class="col-md-12">
            <div class="row">
              <div class="col-md-3">
                <div class="panel panel-default">
                  <div class="panel-body text-center">
                    <h4>{{ $summary['totalLateRecords'] }}</h4>
                    <small>Total Late Records</small>
                  </div>
                </div>
              </div>
              <div class="col-md-3">
              ...
              <div class="col-md-3">
                <div class="panel panel-default">
                  <div class="panel-body text-center">
                    <h4 style="color: orange;">{{ $summary['totalLateMinutes'] }}</h4>
              ...
              <div class="col-md-3">
                <div class="panel panel-default">
                  <div class="panel-body text-center">
                    <h4 style="color: #007bff;">{{ $summary['averageLateMinutes'] }}</h4>
                    <small>Average Late Minutes</small>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="col-md-12">
            ...
            <div class="table-responsive">
              <table class="table table-bordered table-striped">
                ...
                <tbody>
                  @foreach($lateData as $index => $data)
                  <tr>
                    ...
                    <td class="text-center" style="color: orange; font-weight: bold;">{{ $data['lateMinutes'] }}</td>
            ...
            <div class="alert alert-warning">
              <strong>No Late Records Found</strong> for the selected criteria.
            </div>
            @endif
          </div>
        </div>
