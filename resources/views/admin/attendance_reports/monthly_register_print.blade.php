...
<head>
    ...
    <title>Monthly Attendance Register - Print</title>
    <style>
        @media print {
            @page {
                size: A4 landscape;
        ...
        <div class="row mb-4">
            <div class="col-md-12">
                <table style="font-size: 8px;">
                    <tr>
                        <td class="text-center" style="width: 11%;"><strong>Total Employees:</strong> {{ $summary['totalEmployees'] }}</td>
                        <td class="text-center" style="width: 11%; color: green;"><strong>Present:</strong> {{ $summary['totalPresent'] }}</td>
                        <td class="text-center" style="width: 11%; color: orange;"><strong>Late:</strong> {{ $summary['totalLate'] }}</td>
                        <td class="text-center" style="width: 11%; color: #f0ad4e;"><strong>Half Day:</strong> {{ $summary['totalHalfDay'] }}</td>
                        <td class="text-center" style="width: 11%; color: red;"><strong>Absent:</strong> {{ $summary['totalAbsent'] }}</td>
                        <td class="text-center" style="width: 11%; color: #007bff;"><strong>Leave:</strong> {{ $summary['totalLeave'] }}</td>
                        <td class="text-center" style="width: 11%; color: #9b59b6;"><strong>Holiday:</strong> {{ $summary['totalHoliday'] }}</td>
                        <td class="text-center" style="width: 11%; color: gray;"><strong>Weekly Off:</strong> {{ $summary['totalWeeklyOff'] }}</td>
                        <td class="text-center" style="width: 12%; color: #3c8dbc;"><strong>Avg Attendance %:</strong> {{ $summary['averageAttendancePercentage'] }}%</td>
                    </tr>
                </table>
            </div>
        </div>
