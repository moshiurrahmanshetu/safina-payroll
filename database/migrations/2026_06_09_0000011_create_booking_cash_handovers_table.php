...
class CreateBookingCashHandoversTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('booking_cash_handovers', function (Blueprint $table) {
            ...
            $table->foreign('counter_id')->references('id')->on('counters')->onDelete('restrict');
    ...
    {
        Schema::dropIfExists('booking_cash_handovers');
    }
}
