<?php $__env->startSection('title', 'Daily Attendance Entry'); ?>
<?php $__env->startSection('content'); ?>
<h3 class="page-header">Daily Attendance Entry <?php echo e(link_to_route('attendances.index','Attendance List',[],array('class'=>'btn btn-success pull-right'))); ?></h3>

<?php echo e(Form::open(array('route' => 'daily_attendance.store','enctype'=>'multipart/form-data','class'=>'form-horizontal','id'=>'dailyAttendanceForm'))); ?>
        ...
        <div class="row">
          ...
          <div class="col-md-3">
            <div class="form-group">
              ...
              <?php echo $errors->first('attendance_month', '<p class="text-danger">:message</p>'); ?>
          ...
          <div class="col-md-3">
            <div class="form-group">
              ...
              <?php echo $errors->first('attendance_date', '<p class="text-danger">:message</p>'); ?>
        ...
        <div class="row">
          <div class="col-md-3">
            <div class="form-group">
              ...
              <?php echo $errors->first('check_in', '<p class="text-danger">:message</p>'); ?>
          ...
          <div class="col-md-3">
            <div class="form-group">
              ...
              <?php echo $errors->first('check_out', '<p class="text-danger">:message</p>'); ?>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="form-group">
              ...
              <?php echo $errors->first('remarks', '<p class="text-danger">:message</p>'); ?>
...
<div class="row" id="saveSection" style="display: none;">
  <div class="col-md-12">
    <div class="form-group">
      ...
      <a href="<?php echo e(route('daily_attendance.index')); ?>" class="btn btn-danger">
...
$(document).ready(function() {
  ...
  function loadAssignedShift() {
    ...
    $.ajax({
      url: '<?php echo e(route("daily_attendance.get_assigned_shift")); ?>',
      type: 'POST',
      data: {
  ...
  $('#loadDayBtn').click(function() {
    ...
    $.ajax({
      url: '<?php echo e(route("daily_attendance.load_day")); ?>',
      type: 'POST',
      data: {
        _token: '<?php echo e(csrf_token()); ?>',
        user_id: userId,
  ...
  function calculateAttendance() {
    ...
    $.ajax({
      url: '<?php echo e(route("daily_attendance.calculate")); ?>',
      type: 'POST',
      data: {
        _token: '<?php echo e(csrf_token()); ?>',
        user_id: userId,
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\safina-payroll\resources\views/admin/daily_attendance/index.blade.php ENDPATH**/ ?>