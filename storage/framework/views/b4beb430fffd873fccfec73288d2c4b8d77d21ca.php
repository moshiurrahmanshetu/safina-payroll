    <header class="app-header navbar background_blue">
      ...
      <a class="navbar-brand" href="javascript:void(0)">  <img src="<?php echo e(asset('public/img/logo.png')); ?>" alt="Logo" class="img-responsive top_header_img"> </a>
      ...
      <ul class="nav navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown">
          <a class="nav-link txt_white" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
            <img class="img-avatar" src="<?php echo e(asset('storage/app/admin/users/'.$auth_user_photo)); ?>" alt="<?php echo e($auth_user_name); ?>">
          </a>
          ...
          <a class="dropdown-item" href="<?php echo e(url('/admin/password')); ?>">
    ...
    </header><?php /**PATH C:\xampp\htdocs\safina-payroll\resources\views/admin/header.blade.php ENDPATH**/ ?>